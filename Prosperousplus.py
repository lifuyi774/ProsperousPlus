...
if __name__ == "__main__":
    ...
    parser.add_argument('--trainfile', default=None, type=str, help='The path to the training set file containing the protease sequences in fasta(peptide) format, where the length of the sequences is 8/10/12/14/16/18/20.')
    ...
    parser.add_argument('--testfile', default=None,type=str, help='The path to the test data file containing the protease sequences in fasta(peptide) format, where the length of the sequences is 8/10/12/14/16/18/20. If not, it will be divided from the training set.')
    ...
    parser.add_argument('--modelfile',default=None, type=str, help='The file of trained model generated from the TrainYourModel mode. eg 0_model' ) 
    parser.add_argument('--SHAP', default=None, type=str, help='Select Yes or No to control the program to calculate SHAP.')
    parser.add_argument('--PLOT', default=None, type=str, help='Selecting Yes or No to control whether the program computes the visualization of cleavage sites.')
